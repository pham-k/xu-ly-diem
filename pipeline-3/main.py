...
def INFO1001_2021_YRD_1_RHM_2021_LAN1():
    ...
    wh.write_bang_diem_psc_export_INFO1001(
        ...
        mon='Tin học [2 TC]', lop='RHM-2021', 
        lop_hp='211TTO_01000605', lan_thi=obj['lan_thi'],
        ngay_thi='14/04/2022',
...
def INFO1001_2021_YRD_1_DUOC_2021_LAN1():
    ...
    wh.write_bang_diem_psc_export_INFO1001(
        df=data[0], summary=data[1], path=obj['output'],
        footer='INFO1001-2021-YRD-1',
        mon='Tin học [2 TC]', lop='DUOC-2021', 
        lop_hp='211TTO_01000601', lan_thi=obj['lan_thi'],
        ngay_thi='14/04/2022',
        ngay='      ', thang='05', nam='2022'
    )
...
def INFO1001_2021_YRD_1_Y_2021_LAN1():
    ...
    wh.write_bang_diem_psc_export_INFO1001(
        df=data[0], summary=data[1], path=obj['output'],
        footer='INFO1001-2021-YRD-1',
        mon='Tin học [2 TC]', lop='Y-2021', 
        lop_hp='211TTO_01000603', lan_thi=obj['lan_thi'],
        ngay_thi='14/04/2022',
        ngay='      ', thang='05', nam='2022'
    )
...
def INFO1001_2021_YRD_1_HL_1_LAN1():
    ...
    wh.write_bang_diem_psc_export_INFO1001(
        df=data[0], summary=data[1], path=obj['output'],
        footer='INFO1001-2021-YRD-1',
        mon='Tin học [2 TC]', lop='HL-1', 
        lop_hp='211TTO_01000607', lan_thi=obj['lan_thi'],
        ngay_thi='14/04/2022',
        ngay='      ', thang='05', nam='2022'
    )
